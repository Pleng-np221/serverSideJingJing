...
class CreateStudentView(View):
    ...
    def post(self, request):
        ...
        section = request.POST.get('section_ids')
        fac = Faculty.objects.get(pk = faculty)
        sec = Section.objects.get(pk = section)
        new_student = Student.objects.create(student_id = student_id, first_name = first_name, last_name = last_name, faculty = fac, section = sec)
        new_pf = Student.objects.create(student = new_student, email = email, phone = phone, address = address)
